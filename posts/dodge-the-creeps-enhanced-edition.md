...
![an image of the settings menu](/img/settings.png)
...
![an image of the difficulty multiplier in the settings menu](/img/difficulty-multiplier.png)
...
![a gif showing the animation for lives](/img/lives-animation.gif)
...
{{< insertFigure img="high-score.png" caption="High score" command="Resize" align="Middle" options="400x" >}}
...
![a gif showing the crazy movement bug](/img/crazy-movement.gif)
...
![a thank you gif](/img/thank-you.gif) <a href="https://giphy.com/gifs/sticker-osjgQPWRx3cac">[1]</a>

This will probably be the last update to the Dodge the Creep game because I want to try making 1 game in every genre to understand the fundamentals behind some of these games and to experiment more with asset and music creation. In this entire process, I also want to understand more about my strengths and weaknesses and about the kind of games that I find fun to create and play. Hopefully somewhere along the way, I also build a community that I can share my progress with. Thanks for reading :)